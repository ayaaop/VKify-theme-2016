let locales = {
	en: {
		...
		graffiti_close_confirm:
			"Are you sure you want to quit drawing without saving?",
		...
		guest_actions:
			"<a href='/register'>Register now</a> to stay connected with $1 and other people, or <a href='/'>log in</a> if you already have an account.",
		guest_actions_group:
			"<a href='/register'>Register now</a> to join $1 and many other groups, or <a href='/'>log in</a> if you already have an account.",
		recommended_groups: "Recommended groups",
		deleted_attachment:
			"This post contains deleted attachment(s) and doesn't have any text.",
		deleted_attachment_2: "As such, it can't be displayed.",
		vkify_settings: "VKify16 settings",
		dark_mode: "Dark mode",
		mode_2018:
			"Mimic 2018 layout (beta)<div class='nobold'>More saturated colours, rounder buttons, etc.</div>",
		gifts_left: "$1 left",
	...
	ru: {
		...
		graffiti_close_confirm:
			"Вы действительно хотите выйти, не сохранив рисунок?",
		graffiti_color: "Цвет",
		...
		guest_actions:
			"<a href='/register'>Зарегистрируйтесь</a>, чтобы оставаться на связи с $1 и другими людьми, или <a href='/'>войдите</a>, если у вас уже есть аккаунт.",
		guest_actions_group:
			"<a href='/register'>Зарегистрируйтесь</a>, чтобы присоединиться к $1 и многим другим группам, или <a href='/'>войдите</a>, если у вас уже есть аккаунт.",
		recommended_groups: "Рекомендуемые сообщества",
		deleted_attachment:
			"В этой записи содержится удалённое вложение и нет текста.",
		deleted_attachment_2: "Поэтому она не может быть отображена.",
		vkify_settings: "Настройки VKify16",
		dark_mode: "Тёмная тема",
		mode_2018:
			"Имитировать дизайн 2018 года (бета)<div class='nobold'>Более насыщенные цвета, более круглые кнопки, и т.д.</div>",
		...
		sidebar_note:
			"Возможно, вам придется перезагрузить страницу, чтобы изменения вступили в силу.",
	...
	uk: {
		...
		guest_actions:
			"<a href='/register'>Зареєструйтеся</a>, щоб залишатися на зв'язку з $1 та іншими, або <a href='/'>увійдіть</a>, якщо у вас вже є обліковий запис.",
		guest_actions_group:
			"<a href='/register'>Зареєструйтеся</a>, щоб приєднатися до $1 та інших груп, або <a href='/'>увійдіть</a>, якщо у вас вже є обліковий запис.",
		recommended_groups: "Рекомендовані спільноти",
		deleted_attachment:
			"Цей допис містить видалене вкладення та не має тексту.",
		deleted_attachment_2: "Тому він не може бути відображений.",
		vkify_settings: "Налаштування VKify16",
		dark_mode: "Темний режим",
		mode_2018:
			"Імітувати дизайн 2018 року (бета)<div class='nobold'>Більш насыщений колір, кругліші кнопки, і т.д.</div>",
		gifts_left: "$1 осталось",
		...
		sidebar_note:
			"Можливо, вам потрібно перезавантажити сторінку, щоб зміни вступили в силу.",
	...
	kk: {
		...
		guest_actions:
			"$1 және басқа адамдармен байланыста болу үшін <a href='/register'>тіркеліңіз</a> немесе тіркелгіңіз болса, <a href='/'>кіріңіз</a>.",
		guest_actions_group:
			"$1 және басқа да көптеген топтарға қосылу үшін <a href='/register'>тіркеліңіз</a> немесе тіркелгіңіз болса, <a href='/'>кіріңіз</a>.",
		recommended_groups: "Ұсынылатын бірлестіктер",
		deleted_attachment:
			"Бұл жазбада өшірілген қосымша бар және мәтін жазылмаған.",
		deleted_attachment_2: "Сол себепті оны көрсету мүмкін емес.",
		vkify_settings: "VKify16 баптаулары",
		dark_mode: "Күңгірт режим",
		mode_2018:
			"2018 жылғы дизайнды қолдану (бета)<div class='nobold'>Қанық түстер, жұмыр түймелер және т.б.</div>",
		gifts_left: "$1 қалды",
		...
		sidebar_note:
			"Өзгерістер іске қосылуы үшін бетті қайта жүктеуіңіз қажет болуы мүмкін.",
...
window.vkifylocalize = function (langcode, fallback = "en") {
	const fallbackCode = fallback && locales[fallback] ? fallback : "en";

	if (!(langcode in locales)) {
		try {
			fetch(`/themepack/vkify16/3.3.3.5/resource/langs/${langcode}.json`)
				.then((response) => {
					if (!response.ok) {
...
window.processVkifyLocElement = function (element) {
	...
	if (!translatedText && fallback && typeof tr === "function") {
		translatedText = tr(fallback);
	}
