...
<div class="langSelect"><img src="/themepack/vkify16/3.3.1.2/resource/lang_flags/ru.png" style="margin-right: 14px;"><b>Русский</b></div>
</a>
<a href="/language?lg=uk&hash=${encodeURIComponent(window.router.csrf)}&jReturnTo=${encodeURI(window.location.pathname + window.location.search)}">
   <div class="langSelect"><img style="margin-right: 14px;" src="/themepack/vkify16/3.3.1.2/resource/lang_flags/uk.png"><b>Україньска</b></div>
</a>
<a href="/language?lg=en&hash=${encodeURIComponent(window.router.csrf)}&jReturnTo=${encodeURI(window.location.pathname + window.location.search)}">
   <div class="langSelect"><img src="/themepack/vkify16/3.3.1.2/resource/lang_flags/en.png" style="margin-right: 14px;"><b>English</b></div>
</a>
<a href="/language?lg=ru_sov&hash=${encodeURIComponent(window.router.csrf)}&jReturnTo=${encodeURI(window.location.pathname + window.location.search)}">
   <div class="langSelect"><img src="/themepack/vkify16/3.3.1.2/resource/lang_flags/sov.png" style="margin-right: 14px;"><b>Советский</b></div>
</a>
<a href="/language?lg=ru_old&hash=${encodeURIComponent(window.router.csrf)}&jReturnTo=${encodeURI(window.location.pathname + window.location.search)}">
   <div class="langSelect"><img style="margin-right: 14px;" src="/themepack/vkify16/3.3.1.2/resource/lang_flags/imp.png"><b>Дореволюціонный</b></div>
</a>
...
const vkfavicon = {
    "fav": "/themepack/vkify16/3.3.1.2/resource/favicon_vk.ico",
	"fav_chat": "/themepack/vkify16/3.3.1.2/resource/fav_chat.ico",
...
<head>
    ...
    <link rel="stylesheet" href="${window.location.origin}/themepack/vkify16/3.3.1.2/stylesheet/styles.css">
    <link rel="stylesheet" href="${window.location.origin}/themepack/vkify16/3.3.1.2/resource/vkgraffiti/graffiti.css">
</head>
<body style="background: none">
    ...
    <script src="${window.location.origin}/themepack/vkify16/3.3.1.2/resource/vkgraffiti/graffiti.js"></script>
    <script>
        var cur = {"lang": {
...
if (today.getDate() === 1 && today.getMonth() === 3) {
    ...
    doge.setAttribute('src', '/themepack/vkify16/3.3.1.2/resource/doge.js');
...
window.toggleDarkMode = function(enabled) {
    ...
    if (enabled) {
        ...
        if (!darkModeLink) {
            ...
            link.rel = 'stylesheet';
            link.href = '/themepack/vkify16/3.3.1.2/resource/css/dark-mode.css';
